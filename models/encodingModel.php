<?php include "../models/DBconnection.php";  
    ...
    class encodingModel extends DBconnection {
        ...
        function addaccount($encode){
            ...
            VALUES (\"".$encode['accID']."\",\"".$encode['memberID']."\",\"".$encode['AccuBal']."\",\"".$encode['dailyP']."\",
        ...
        function addRecord($encode){
            $query="INSERT INTO `records`(`recordID`, `accID`, `AccuBal`, `AdvBal`, `recDate`,  `description`) 
            VALUES (\"".$encode['recordID']."\",\"".$encode['accID']."\",\"".$encode['AccuBal']."\",\"".$encode['AdvBal']."\",\"".$encode['regDate']."\",\"".$encode['description']."\")";
            $result = mysqli_query($this->conn,$query);
            if(!$result){
                die("<strong>WARNING:</strong><br>" . mysqli_error($this->conn));
                return mysqli_error($this->conn);
