                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="clearfix"></div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="accbal"> Absent <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="accbal" type="text" id="accbal" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="rbalance"> Remaining Balance
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="rbalance" type="text" id="rbalance" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
